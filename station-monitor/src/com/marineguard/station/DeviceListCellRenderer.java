...
public class DeviceListCellRenderer extends JPanel implements ListCellRenderer<DeviceTelemetry> {
    ...
    public DeviceListCellRenderer() {
        ...
        batteryLabel.setFont(batteryLabel.getFont().deriveFont(Font.PLAIN, 15f));
    ...
    public Component getListCellRendererComponent(JList<? extends DeviceTelemetry> list, DeviceTelemetry value, int index, boolean isSelected, boolean cellHasFocus) {
        ...
        batteryLabel.setText("Battery " + (value.getBattery() >= 0 ? value.getBattery() + "%" : "n/a"));
        ...
        } else if (value.getBattery() >= 0 && value.getBattery() < 20) {
            panelColor = new Color(92, 51, 18);
        ...
        batteryLabel.setForeground(value.getBattery() >= 0 && value.getBattery() < 20 ? AppTheme.WARNING : AppTheme.TEXT);
