...
public class VitalsGaugePanel extends JPanel {
    ...
    protected void paintComponent(Graphics graphics) {
        ...
        int bpm = !hasTelemetry ? 0 : telemetry.getBpm();
        ...
        String value = telemetry == null || telemetry.getBpm() <= 0 ? "--" : String.valueOf(telemetry.getBpm());
    ...
    private Color statusColor() {
        ...
        if (telemetry.isStale(System.currentTimeMillis())) {
            return AppTheme.OFFLINE;
        }
